...
function PageHeadingSkeleton() {
  return (
    <div className="page-heading space-y-2">
...
export function DashboardSkeleton() {
  return (
    <div className="page-shell space-y-6" aria-label="Loading dashboard">
      <section className="surface-panel px-5 py-7">
        <SkeletonLine className="h-4 w-20" />
        <SkeletonLine className="mt-3 h-8 w-full max-w-sm" />
...
export function VehiclesSkeleton() {
  return (
    <div className="page-shell space-y-6" aria-label="Loading vehicles">
      <PageHeadingSkeleton />
      <CardSkeleton rows={5} />
      <div className="space-y-3">
        <CardSkeleton rows={2} />
...
export function HistorySkeleton() {
  return (
    <div className="page-shell space-y-6" aria-label="Loading history">
      <PageHeadingSkeleton />
...
export function NotificationsSkeleton() {
  return (
    <div className="page-shell space-y-6" aria-label="Loading notifications">
      <PageHeadingSkeleton />
      <div className="space-y-3">
        <CardSkeleton rows={2} />
        <CardSkeleton rows={2} />
